...
export async function exportTrajectoryRunHtml(options: TrajectoryExportOptions): Promise<string> {
  ...
  output = inlineAsset(output, '<script src="./prism.min.js"></script>', script(prism));
